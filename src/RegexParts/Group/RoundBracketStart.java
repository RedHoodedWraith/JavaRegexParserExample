...
public class RoundBracketStart extends RoundBracketTemplate {
    ...
    public RoundBracketStart(char[] patt, int index, int groupLayer, RoundBracketStart groupStart) throws RegexSyntaxError {
        super(patt, index, ++groupLayer,'(', true, false, groupStart,
